...
class SalePage extends StatelessWidget {
  ...
  final _memoryBloc = ThreadNumBloc(
      baseUrl:
  ...
  final _totalBloc = ThreadNumBloc(
      baseUrl:
        ...
        Expanded(
          child: GridView(
            ...
            children: [
              ...
              SfApmLineChart(_totalBloc, title: "环境变化趋势概览",)
            ],
          ),
        ),
        Container(
